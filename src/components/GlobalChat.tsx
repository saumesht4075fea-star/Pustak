    ...
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
          ...
          >
            ...
            <div className="p-4 bg-zinc-900 text-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-black italic uppercase tracking-tight">Community Chat</h3>
              ...
              <>
                ...
                >
                  {messages.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-center space-y-2 opacity-50">
                      ...
                      <p className="text-xs font-bold uppercase tracking-widest text-zinc-400">No messages yet</p>
                    </div>
                  ) : (
                    messages.map((msg) => (
                      <div 
                ...
                <form onSubmit={sendMessage} className="p-4 bg-white border-t border-zinc-100 flex gap-2">
                  <Input 
                    ...
                    className="h-10 rounded-xl bg-zinc-50 border-zinc-200 text-sm focus:ring-zinc-200 shadow-inner"
                  />
                  <Button 
                    type="submit" 
                    size="icon"
                    disabled={!inputText.trim() || isLoading}
                    className="h-10 w-10 bg-zinc-900 hover:bg-black rounded-xl shrink-0 shadow-lg"
                  >
      ...
      <Button 
        ...
        className={`h-14 w-14 rounded-full shadow-2xl transition-all ${
          isOpen ? 'bg-zinc-900 hover:bg-black' : 'bg-blue-600 hover:bg-blue-700'
        }`}
      >
